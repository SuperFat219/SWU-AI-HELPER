 ...
 *     C:\exercise>start java Exercise42_2Client
 */
...
public class Exercise43_7Client extends JFrame {
  // Chat server
  private Exercise43_7RemoteInterface server;
  ...
  protected boolean initializeRMI() throws Exception {
    ...
    try {
      ...
      server = (Exercise43_7RemoteInterface)registry.lookup(
        "ChatServer");
    ...
    Exercise43_7CallbackInterfaceImpl callBack = new
      Exercise43_7CallbackInterfaceImpl(this);

    // Attempt to connect to the server
    if ((server.connect((Exercise43_7CallbackInterface)callBack)) != false) {
      return true;
    }
    else {
